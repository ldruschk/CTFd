...
class Config(object):
    ...
    OAUTH_API_ID_KEY = os.getenv("OAUTH_API_ID_KEY")
    OAUTH_API_NAME_KEY = os.getenv("OAUTH_API_NAME_KEY")
    OAUTH_API_EMAIL_KEY = os.getenv("OAUTH_API_EMAIL_KEY")
    OAUTH_API_TEAM_ID_KEY = os.getenv("OAUTH_API_TEAM_ID_KEY")
    OAUTH_API_TEAM_NAME_KEY = os.getenv("OAUTH_API_TEAM_NAME_KEY")
